...
# depending on whether Garage is running, cmd/stratus is main(), and
...
#
# One consequence worth knowing: if Garage is not running, the S3 conformance
...
# that has it.
#
# internal/storage/s3 likewise: the multipart sweep is exercised against Garage,
